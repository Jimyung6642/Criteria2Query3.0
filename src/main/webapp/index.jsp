    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="masthead-button-links">
                <a role="button" class="btn btn-success" id="start" style="font-size: 17px;">&nbsp;&nbsp;Parse Criteria&nbsp;&nbsp;</a>
                <a role="button" class="btn btn-info" id="reset" style="font-size: 17px;">&nbsp;&nbsp;&nbsp;Reset&nbsp;&nbsp;&nbsp;</a>
            </div>
        </div>
        <div id="sentenceParsingResult" class="col-sm-12 col-md-12 col-lg-12 col-xl-12" style="display:none; margin-top:10px">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                ...
                <div class="panel-body">
                    <div class="help-block"><b>Please note:</b> <br>
                        ...
                        <a class="badge" id="categoryExamples" data-toggle="modal" data-target="#modalCategoryExamples">(click to see examples)</a>
                    ...
                    <table id="initialeventtable"
                           class="table table-bordered col-sm-12 col-md-12 col-lg-12 col-xl-12"
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseExplain">
                                    <span class="glyphicon glyphicon-zoom-in"></span>
                                     GPT Explain
                                </a>
                            </h4>
                        </div>
                        <div id="collapseExplain" class="panel-collapse collapse" style="height: 0px;">
                            <div class="panel-body">
                                <span class="help-block"> GPT exlpains the logics, relations, and negation that showed in the GPT-extracted concept and generated query. </span>
                                <span>
                                    <textarea id="gptexplain" class="form-control" rows="20"></textarea>
                                </span>     
                            </div>                                                   
                        </div>    
                    </div>   
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12" id="buttons_group" style="display: none">
        ...
        <div id="resultSection" class="col-sm-12 col-md-12 col-lg-12 col-xl-12" style="display:none;margin-top:10px">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                ...
                <div class="panel-body">
                    ...
                    <table id="result"
                           class="table table-bordered col-sm-12 col-md-12 col-lg-12 col-xl-12" style="table-layout:fixed;">
                    </table>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function parse(dataset) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#gptexplain").val(data["gpt_explain"]);
                // $('#gptexplain').bootstrapTable('destroy');
                // $('#gptexplain').bootstrapTable(
                //    {
                //        formatNoMatches: function () {
                //            return '';
                //        },
                //        cache: false,
                //        data: data["gpt_explain"],
                //        columns: [
                //            {
                //                field: 'id',
                //                title: '#',
    ...
    function processData(dataset) {
        ...
        var daysafter = $("#obend").val();
        var limitto = $("#limitto").val();
        var explain = $("#gptexplain").val().trim().replace(/^\s+|\s+$/g, '').trim();
        $.blockUI({
